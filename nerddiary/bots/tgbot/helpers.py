...
def tg_pretty_print_answers(
    ...
    for q, a in zip(print_questions, answers):
        text += '<b>"' + html.escape(q) + '"</b>: ' + "<i>" + html.escape(a.label) + "</i>\n"
...
def generate_buttons(
    ...
    header_buttons: Dict[str, str] | Tuple[str, str] | List[Tuple[str, str]] | List[List[str]] = None,
    footer_buttons: Dict[str, str] | Tuple[str, str] | List[Tuple[str, str]] | List[List[str]] = None,
